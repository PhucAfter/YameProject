...
delete from NHANVIEN where MANV = 'BHYAME001'
...
(
	...
	GIAMDOITRA INT DEFAULT 0,
	THUDOITRA INT DEFAULT 0
	CONSTRAINT BANGTHANHTOAN_MAHD_FK FOREIGN KEY(MAHD) REFERENCES HOADON(MAHD)
)
GO
--select * from BANGTHANHTOAN
INSERT INTO BANGTHANHTOAN (MAHD,TONGHOADON,GIAMTRUCTIEP,GIAMVOUCHER,TIENPHAITHU) VALUES ('101022000000000001',39000,19500,0,20000)
INSERT INTO BANGTHANHTOAN (MAHD,TONGHOADON,GIAMTRUCTIEP,GIAMVOUCHER,TIENPHAITHU) VALUES ('111022000000000002',39000,19500,0,20000)
INSERT INTO BANGTHANHTOAN (MAHD,TONGHOADON,GIAMTRUCTIEP,GIAMVOUCHER,TIENPHAITHU) VALUES ('121022000000000003',39000,19500,0,20000)
...
(
	...
	NGAYHETHAN DATE DEFAULT DATEADD(month, 1, GETDATE()),
...
insert into HOADON values ('000','2022/11/25','BHYAME001','0')
insert into CTHD values ('000','0015529','000',2,39000,0.5,39000)
insert into BANGTHANHTOAN values ('000',78000, 39000,0,39000)
insert into VOUCHER values ('000',0,'2022/12/25',20000,2000)

CREATE TABLE TEST
(
	MAS INT NOT NULL,
	NGAYHOMNAY DATE DEFAULT GETDATE(),
	TUANSAU DATE DEFAULT DATEADD(week, 1, GETDATE()),
	THANGSAU DATE DEFAULT DATEADD(month, 1, GETDATE())
)
select top 1 MAS from TEST ORDER BY MAS DESC
INSERT INTO TEST (MAS) VALUES (1)
SELECT FORMAT(NGAYHOMNAY,'dd/MM/yyyy ') FROM TEST
drop table TEST

SELECT HOTEN,SDT,PHANTRAMGIAM FROM KHACHHANG,VITHANHVIEN WHERE KHACHHANG.MATV = VITHANHVIEN.MATV
SELECT KHACHHANG.MATV,HOTEN,PHANTRAMGIAM FROM KHACHHANG,VITHANHVIEN WHERE KHACHHANG.MATV = VITHANHVIEN.MATV
SELECT TENSP, TENSIZE, DONGIA FROM SANPHAM_SIZE, SANPHAM, SIZE WHERE SANPHAM_SIZE.MASP = SANPHAM.MASP AND SANPHAM_SIZE.MASIZE = SIZE.MASIZE AND SANPHAM_SIZE.MASP = '0015529' AND SANPHAM_SIZE.MASIZE = '000'
SELECT PHANTRAMGIAM FROM SANPHAM WHERE MASP = '0015529'
select * from SANPHAM
select * from SANPHAM_SIZE