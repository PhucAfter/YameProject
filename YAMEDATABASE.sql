...
--SELECT SANPHAM_SIZE.MASP,SANPHAM_SIZE.MASIZE,TENSP,TENSIZE,SOLUONG,DONGIA,DONVI,GIAMPHANTRAM FROM SANPHAM_SIZE,SANPHAM,SIZE WHERE SANPHAM_SIZE.MASP = SANPHAM.MASP AND SANPHAM_SIZE.MASIZE = SIZE.MASIZE
